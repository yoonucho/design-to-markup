...
**Responsive**: Sass Mixin으로 커스텀 breakpoint를 정의하고, 다양한 화면 크기에서도 자연스럽게 동작하도록 **Fluid Layout**을 적용했습니다.
...
6.  **폴더 대소문자 문제 대응**
    ...
    * `git mv`를 두 번 사용해 `video` → `Video`로 명시적으로 변경
